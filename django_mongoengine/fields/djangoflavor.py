...
from vendor.django_mongoengine.forms import fields as formfields
...
class StringField(DjangoField):
    def formfield(self, form_class=forms.CharField, choices_form_class=None, **kwargs):
        ...
        defaults.update(kwargs)
        return super(StringField, self).formfield(
            form_class, choices_form_class, **defaults
        )
...
class DictField(DjangoField):
    def formfield(self, **kwargs):
        ...
        defaults = {"validators": validators, "form_class": formfields.DictField}
