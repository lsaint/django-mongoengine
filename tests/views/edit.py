...
class CreateViewTests(MongoTestCase):
    ...
    def test_create_with_object_url(self):
        res = self.client.post(
            "/edit/artists/create/", {"id": 1, "name": "Rene Magritte"}
        )
        self.assertEqual(res.status_code, 302)
...
class UpdateViewTests(TestCase):
    ...
    def test_update_with_object_url(self):
        ...
        res = self.client.post(
            "/edit/artists/%s/update/" % a.pk, {"id": "1", "name": "Rene Magritte"}
        )
        self.assertEqual(res.status_code, 302)
    ...
    def test_update_with_redirect(self):
        a = Author.objects.create(id="1", name="Randall Munroe", slug="randall-munroe")
        res = self.client.post(
            "/edit/author/%s/update/redirect/" % a.pk,
            {
                "id": "1",
    ...
    def test_update_with_special_properties(self):
        ...
        res = self.client.post(
            "/edit/author/%s/update/special/" % a.pk,
            {
                "id": "1",
                "name": "Randall Munroe (author of xkcd)",
                "slug": "randall-munroe",
    ...
    def test_update_without_redirect(self):
        with self.assertRaises(ImproperlyConfigured):
            ...
            self.client.post(
                "/edit/author/%s/update/naive/" % a.pk,
                {
                    "id": "1",
                    "name": "Randall Munroe (author of xkcd)",
                    "slug": "randall-munroe",
    ...
    def test_update_get_object(self):
        a = Author.objects.create(pk="1", name="Randall Munroe", slug="randall-munroe")
