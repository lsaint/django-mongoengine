...
urlpatterns = [
    ...
    url(r"^detail/author/byslug/(?P<slug>[\w-]+)/$", views.AuthorDetail.as_view()),
    url(
    ...
    url(r"^detail/author/invalid/qs/$", views.AuthorDetail.as_view(queryset=None)),
    # Create/UpdateView
    ...
    url(r"^edit/authors/create/special/$", views.SpecializedAuthorCreate.as_view()),
    url(r"^edit/author/(?P<pk>\d+)/update/naive/$", views.NaiveAuthorUpdate.as_view()),
    url(
    ...
    url(r"^edit/author/(?P<pk>\d+)/delete/naive/$", views.NaiveAuthorDelete.as_view()),
    url(
    ...
    url(r"^list/artists/$", views.ArtistList.as_view(), name="artists_list"),
    url(r"^list/authors/$", views.AuthorList.as_view(), name="authors_list"),
