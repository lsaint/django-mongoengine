...
class DictFieldTest(MongoTestCase):
    ...
    def test_ouput(self):
        ...
        valid_input = {
            ...
            "[[key1,value1],[skey,[[skey1,svalue1],[skey2,svalue2],[skey3,svalue3]]],[key2,value2],[key3,value3]]": [
                ...
                [
                    "skey",
                    [["skey1", "svalue1"], ["skey2", "svalue2"], ["skey3", "svalue3"]],
                ],
                ["key2", "value2"],
                ["key3", "value3"],
            ],
        ...
        valid_output = {
            ...
            "[[key1,value1],[skey,[[skey1,svalue1],[skey2,svalue2],[skey3,svalue3]]],[key2,value2],[key3,value3]]": {
                "key1": "value1",
                "skey": {"skey1": "svalue1", "skey2": "svalue2", "skey3": "svalue3"},
                "key2": "value2",
                "key3": "value3",
            },
            "[[a,[[b,[[c,[[d,[[e,[[f,g]]]]]]]]]]]]": {
        ...
        invalid_input = {
            ...
            "[[keykeykeykeykeykeykeykeykeykeykey,value1],[key2,value2]]": [
                ["keykeykeykeykeykeykeykeykeykeykey", "value1"],
                ["key2", "value2"],
            ],
        ...
        invalid_message = {
            ...
            % self.field.key_limit,
            "[[err,value1],[key2,value2]]": self.field.error_messages["invalid_key"]
            % self.field.invalid_keys,
            "[[errmsg,value1],[key2,value2]]": self.field.error_messages["invalid_key"]
            % self.field.invalid_keys,
            "[[key1,[key2,[key3,[key4,value4]]]]]": self.field.error_messages["depth"]
            % max_depth_test,
        }
    ...
    def test_rendering(self):
        ...
        for data, datadict in data_inputs.items():
            self.field.widget.render(
                "widget_name",
                self.field.widget.value_from_datadict(datadict, {}, "widget_name"),
            )
            self._check_structure(
                self.field.widget, output_structures[data], "test_rendering:1"
            )
            self.field.widget.render("widget_name", data_dicts[data])
            self._check_structure(
                self.field.widget, output_structures[data], "test_rendering:2"
            )
